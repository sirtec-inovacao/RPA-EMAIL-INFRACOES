...
class EmailSender:
    def __init__(self, smtp_server: str = 'smtp.sirtec.com.br', smtp_port: int = 465,
                 username: str = 'time.inovacao@sirtec.com.br', password: str = '1W>6b[D%qd97iVK1Y.f@'):
    ...
    def get_date_range_text(self) -> tuple:
        ...
        return yesterday_text, last_month_text, yesterday_text
    ...
    def send_email(self, to_list: List[str], cc_list: List[str], 
        ...
        try:
            ...
            try:
                ...
                # Get formatted dates
                yesterday_date, start_date, end_date = self.get_date_range_text()
        ...
        return """
            ...
            <body>
               <div class="container">
                     ...
                     {ranking_02}
                     <p>3) Ranking Top 5 do dia {start_date} até {end_date}:</p>
                     {ranking_03}
